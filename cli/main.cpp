...
int usage() {
    std::printf(
        ...
        "                       [--image <png>]... [--output-resolution N]\n"
        "                       (--image is a Qwen-Image 2.1 CONDITION image:\n"
        "                        context the model reads, not a latent the\n"
        "                        sampler starts from. Repeat it for several.\n"
        "                        Without --width/--height the canvas comes\n"
        "                        from the last image's aspect ratio at\n"
